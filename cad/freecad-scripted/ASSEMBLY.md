...
cad/freecad/
  ...
  build.py             knows the ten part folders, named for the sub-assembly
  ...
  archive/             built, and consumed by no assembly any more
    ...
    top-z-axis-bearing-mount.py  TOP_Z_AXIS_BEARING_MOUNT  what rides the rod
                       (the bracket that stands the rod up is a bottom frame
                        part: bottom-frame/bot-z-axis-bracket.py, in both hands)
  asm/
...
geometry that the assembly has to line up with. They are
