...
**Retired.**  Michael has replaced both of them with
[`../top-frame/top-bearing-mount-z-axis.py`](../top-frame/top-bearing-mount-z-axis.py),
which runs on an LM8UU instead of clamping the rod, so the lid slides rather
than being slackened off and moved by hand.  Nothing in the machine consumes
this part any more; it is kept because the author's design uses it.
